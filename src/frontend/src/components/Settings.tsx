            ...
            >
              {loading && (
                <Box sx={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <Typography sx={{ color: grey[600] }}>Loading profile...</Typography>
                </Box>
              )}
              ...
              {!loading && !error && (
                <Box sx={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                  ...
                  <Box>
                    <Typography sx={{ fontSize: "11px", textTransform: "uppercase", color: grey[500], letterSpacing: "0.06em" }}>
                      Name
                    </Typography>
                    <Typography sx={{ fontSize: "14px", color: grey[900], mt: "2px" }}>
                      {name || "-"}
                    </Typography>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Typography sx={{ fontSize: "13px", color: grey[700], mt: "2px", fontFamily: "monospace" }}>
                      {id || "-"}
                    </Typography>
                  </Box>
                </Box>
